package org.jeet.ctimelineview;
   ...
   // Animation startAnimation;
    ...
    public TimelineViewAdapter(Context context, int resource, ArrayList<TimelineRow> objects, boolean orderTheList) {
      ...
      //  startAnimation = AnimationUtils.loadAnimation(context, R.anim.blinking_animation);
        myFadeInAnimation = AnimationUtils.loadAnimation(context, R.anim.zoom_in);
        myFadeOutAnimation = AnimationUtils.loadAnimation(context, R.anim.zoom_out);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(No==position)
        {
            //rowImage.startAnimation(startAnimation);
            rowImage.startAnimation(myFadeInAnimation);

            //rowImage.startAnimation(myFadeOutAnimation);
